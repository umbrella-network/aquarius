...
import {getKeyPairFromSecretKeyString} from '../utils';
dotenv.config();
...
describe('utils', async () => {
  ...
  it('create key pair from uint8 array string', async () => {
    const keyString = '[17,173,166,247,79,12,33,53,159,165,130,22,51,203,52,61,253,99,9,69,210,20,5,60,199,216,186,234,153,157,89,77,181,84,135,206,59,82,28,32,106,246,25,194,49,170,78,99,146,205,109,207,56,210,145,175,68,170,98,178,151,105,105,174]';
