...
import {derivePDAFromFCDKey, getReturnLog} from './utils';
...
const chainProgramId = process.env.SOLANA_CHAIN_PROGRAM_ID;
const callerProgramId = process.env.SOLANA_CALLER_PROGRAM_ID;

const IDL = JSON.parse(fs.readFileSync('./target/idl/caller.json', 'utf8'));
